                ...
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="All Students" href="{{route('roles.index')}}"><span
                                            class="mini-sub-pro {{Nav::isResource('roles')}}">Roles</span></a></li>
                            <li><a title="Add Students" href="{{route('permissions.index')}}"><span
                                            class="mini-sub-pro {{Nav::isResource('permissions')
                    }}">Permissions</span></a>
                            </li>
                        </ul>
                    </li>
